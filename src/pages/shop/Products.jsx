        ...
        {visibleProducts < filteredProducts.length && (
          <div className="flex justify-center items-center mt-8">
            <button
              ...
              className="text-primary font-bold flex items-center px-4 py-2 rounded-full hover:text-black gap-1 hover:bg-secondary transition-colors"
            >
              View More
              <img src={btnIcon} alt="View more icon" />
            </button>
          </div>
        )}
      </div>
